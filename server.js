...
// Cost endpoints removed

// Tool-calls removed (since SQL/deep inspection is being limited)

// SQL endpoints removed
...
app.get('/api/share-image', (req, res) => {
  try {
    ...
    const svg = generateShareSvg(overview, stats, null, opts);
